      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          >
            ...
            <option value="Shangri-la-Town">Malleshwaram</option>
            <option value="Northern-Kunlun-Mountain">JP Nagar</option>
            <option value="Western-Shangri-la">Ashwath Nagar</option>
            <option value="Naboo-Vallery">Jayanagar</option>
