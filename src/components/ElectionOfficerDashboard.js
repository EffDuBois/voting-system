...
const ElectionOfficerDashboard = () => {
  ...
  const fetchWinnerAndSeats = async () => {
    try {
      const response = await fetch(`${URL}/gevs/results`);
      if (response.ok) {
  ...
  const fetchElectionResults = async () => {
    try {
      const response = await fetch(`${URL}/api/election-results`);
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchElectionData = async () => {
    try {
      ...
      const statusResponse = await fetch(`${URL}/api/election-status`);
      ...
      const resultsResponse = await fetch(`${URL}/api/election-results`);
  ...
  const fetchElectionStatus = async () => {
    try {
      const response = await fetch(`${URL}/api/election-status`);
      if (response.ok) {
        const data = await response.json();
  ...
  const startElection = async () => {
    try {
      const response = await fetch(`${URL}/api/start-election`, {
        method: 'POST',
        headers: {
  ...
  const endElection = async () => {
    try {
      const response = await fetch(`${URL}/api/end-election`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
